...
//    String uploadPart;
    ...
    public String upImg(@RequestParam MultipartFile file){
        ...
        try {
            FileCopyUtils.copy(file.getBytes(),new File("/mnt/54805B1C158071A5/JetBrain-CodeGym/CodeGym_AllModule_Courseware/Module4_CG/Week3/demo_case/c0322g1_Product_FE_Ajax/img/" + name));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return "/c0322g1_Product_FE_Ajax/img/"+name;
    }
